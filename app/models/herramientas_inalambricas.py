...
class HerramientasInalambricas(db.Model):
    __tablename__ = 'herramientas_inalambricas'
    idherramientasinalambricas = db.Column(db.Integer, primary_key=True)
    ...
    estante = db.relationship('Estantes', back_populates='herramientas_inalambricas')