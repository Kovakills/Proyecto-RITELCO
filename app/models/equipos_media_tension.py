...
class EquiposMediaTension(db.Model):
    __tablename__ = 'equipos_media_tension'
    idmediatension = db.Column(db.Integer, primary_key=True)
    ...
    estante = db.relationship('Estantes', back_populates='equipos_media_tension')